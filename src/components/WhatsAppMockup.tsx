const WhatsAppMockup = () => {
  return (
    <div className="bg-card rounded-[28px] shadow-2xl p-4 border border-border">
      <div className="rounded-[22px] overflow-hidden">
        ...
        <div className="bg-muted p-6 space-y-4 min-h-[400px]">
          <div className="max-w-[85%] bg-card border border-border rounded-xl rounded-tl-none p-3 text-sm shadow-sm">
          ...
          <div className="max-w-[85%] bg-card border border-border rounded-xl rounded-tl-none p-3 text-sm shadow-sm">
            Oke, masukkan data hari ini: <span className="font-semibold">mortalitas, pakan, dan berat rata-rata.</span> Pisahkan dengan koma. Contoh: `2, 40 kg, 1.8 kg`
          </div>
          <div className="flex justify-end">
            <div className="max-w-[85%] bg-emerald-600 text-white rounded-xl rounded-tr-none p-3 text-sm shadow-sm">
              1, 45 kg, 1.9 kg
